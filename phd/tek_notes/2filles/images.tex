...
\begin{array}{ll}
    \rotatebox[origin=c]{90}{Programme} \left\{
        ...
        \begin{array}{ll}
        \rotatebox[origin=c]{0}{Sp�cification} & \left\{
                    \begin{array}{p{.5cm}l}
                  \multicolumn{2}{l}{\mbox{Variables Pertinentes}} \\
            & \mbox{$
        %% 3 - variable pertinente
$} \\
                  \multicolumn{1}{l}{\mbox{D�composition}}\\
            & \lefteqn{\mbox{$
        %% 4 - Conjointe
$}  }\\
            & \quad \mbox{$
        %% 5 - Decomposition
$} \\
            \multicolumn{2}{l}{\mbox{Formes Param�triques}}\\
            & \mbox{ $
...
\vspace{4cm}
		...
		{\bf Une m�re a deux enfants dont l'un est un gar�on. Quelle est la probabilit� que l'autre soit une fille ?}\\
		et\\
...
\providecommand{\sd}{\;}
%
\providecommand{\pb}{programme bay\'esien }%
\providecommand{\pbs}{programmes bay\'esiens }%
\providecommand{\p}{probabilit� }
%
